...
//! Generated file from `feedproxy_api.proto`
...
impl<'a> ::std::default::Default for &'a FeedProxyResponse {
    fn default() -> &'a FeedProxyResponse {
        <FeedProxyResponse as ::protobuf::Message>::default_instance()
    }
}
...
impl<'a> ::std::default::Default for &'a SubwayStatus {
    fn default() -> &'a SubwayStatus {
        <SubwayStatus as ::protobuf::Message>::default_instance()
    }
}
