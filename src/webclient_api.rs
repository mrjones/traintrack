...
.DirectionR	d\
    irection$
line_color_hex (	RlineColorHex\
    (
arrivals (2.LineArrivalRarrivals\
    )

debug_info (2
.DebugInfoR	debugInfoJ\
    \"Y
TrainItineraryArrival
	timestamp\
     (R	timestamp\"
...
.D\
    irectionR	direction$
line_color_hex (	Rlin\
    eColorHex0
arrival (2.TrainItineraryArri\
    valRarrival%
data_timestamp (RdataTime\
    stamp)
